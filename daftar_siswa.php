...
<body>
	<div class="container col-md-6 mt-4">
              ...
              <div class="col-md-4">
                <select class="form-select" name="jeniskelamin" id="jeniskelamin">
                  ...
                  <option value="Other">Other</option>
					...
					<div class="form-group">
						<input type="text" hidden name="status" value="Belum Di Konfirmasi" class="form-control">
						</div>
  	...
  	// execute query
					...
					$datas = mysqli_query($db, "insert into siswa (id, name,tanggalLahir,email,alamat,jeniskelamin,image, image_text, status)values('$id', '$name', '$tanggalLahir', '$email', '$alamat', '$jeniskelamin', '$image', '$image_text', '$status')") or die(mysqli_error($db));
